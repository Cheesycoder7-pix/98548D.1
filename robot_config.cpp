...
motor leftMotorC = motor(PORT12, ratio6_1, false);
...
smartdrive Drivetrain = smartdrive(LeftDriveSmart, RightDriveSmart, DrivetrainInertial, 319.19, 320, 40, mm, 1.6528925619834711);
controller Controller1 = controller(primary);


motor Motor1 = motor(PORT1, ratio18_1, true);
motor Motor3 = motor(PORT2, ratio18_1, true);
